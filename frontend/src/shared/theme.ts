 ...
 * 
 * This file contains all the design tokens for the LifeLog design system.
 * It serves as the single source of truth for colors, typography, spacing, and other design values.
 */
...
export const theme = {
  ...
  semantic: {
    ...
    text: {
      ...
      link: '#0ea5e9',        // primary-500
      linkHover: '#0284c7',   // primary-600
    },
...
export type ColorPalette = typeof theme.colors.primary;
