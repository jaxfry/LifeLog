...
def write_events_to_db(con: DuckDBPyConnection, events_df: pl.DataFrame):
    """
    ...
    try:
        ...
        # Insert detailed data for the newly added events
        con.execute("""
        ...
        while True:
            try:
                ...
                if not all_new_events:
                    # No new events, wait for the next polling interval
                ...
                if records_for_db:
                    ...
                    write_events_to_db(db_con, events_df)
